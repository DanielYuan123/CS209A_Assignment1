...
public class OnlineCoursesAnalyzer {
    ...
    public Map<String, List<List<String>>> getCourseListOfInstructor() {
        List<Course> courses= courseStreamGenerator.get().sorted(new Comparator<Course>() {
            @Override
            public int compare(Course o1, Course o2) {
                return o1.courseTitle.compareTo(o2.courseTitle);
            }
        }).toList();
        Map<String,List<List<String>>> get = instructorsSet.stream()
                .collect(Collectors.toMap(new Function<String, String>() {
                    @Override
                    public String apply(String s) {
                        return s;
                    }
                }, new Function<String, List<List<String>>>() {
